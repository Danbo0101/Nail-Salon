...
const Footer = () => {
    return (
        <div>
            <div className="bg-black text-gray-300 py-16 px-44 flex flex-col md:flex-row justify-center items-start gap-16 ">
                <div className="w-1/2 flex flex-col md:flex-row gap-8">
                    <div className="w-1/2 md:w-full h-96">
                        <iframe
                ...
                <div className="w-1/2 flex flex-col md:flex-row">
                    <div className="w-full md:w-1/2 text-left space-y-6">
                        <div>
                            <div className="text-yellow-500 brightness-90 font-semibold uppercase text-sm">Store Location</div>
            ...
            <div className="bg-[#181818] text-gray-400 text-center py-8">
                <div className="flex flex-col items-center space-y-4">
                    <img src={logoFooter} alt="Logo" className="w-24 h-24" />
